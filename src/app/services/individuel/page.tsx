...
export default function IndividuelPage() {
  ...
  const whoIcons = [Briefcase, User, Lightbulb, Palette];
  const whoItems = [
    tr("funnel.individual.who.item1"),
    tr("funnel.individual.who.item2"),
    tr("funnel.individual.who.item3"),
    tr("funnel.individual.who.item4"),
  ];

  const whatIcons = [Bot, MessageSquare, Repeat, ImageIcon];
  const whatItems = [
    tr("funnel.individual.what.item1"),
    tr("funnel.individual.what.item2"),
    tr("funnel.individual.what.item3"),
    tr("funnel.individual.what.item4"),
  ];

  const steps = [
    {
      icon: Phone,
      title: tr("funnel.individual.how.step1.title"),
      desc: tr("funnel.individual.how.step1.desc"),
    },
    {
      icon: Video,
      title: tr("funnel.individual.how.step2.title"),
      desc: tr("funnel.individual.how.step2.desc"),
    },
    {
      icon: HeartHandshake,
      title: tr("funnel.individual.how.step3.title"),
      desc: tr("funnel.individual.how.step3.desc"),
    },
  ];
        ...
        <section className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-28">
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="max-w-3xl">
              ...
              >
                <span className="gradient-text">{tr("funnel.individual.hero.title")}</span>
              </motion.h1>
              ...
              >
                {tr("funnel.individual.hero.subtitle")}
              </motion.p>
        ...
        <section className="relative py-20 lg:py-28">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              ...
              >
                {tr("funnel.individual.who.title")}
              </motion.h2>
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              <motion.h2
                ...
                className="text-3xl font-bold tracking-tight text-white sm:text-4xl"
              >
                {tr("funnel.individual.what.title")}
              </motion.h2>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              <motion.h2
                ...
                className="text-3xl font-bold tracking-tight text-white sm:text-4xl"
              >
                {tr("funnel.individual.how.title")}
              </motion.h2>
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/5 bg-card p-8 text-center transition-all duration-500 hover:border-primary/20 hover:bg-card-hover hover:shadow-lg hover:shadow-primary/5">
                        ...
                        <div className="relative">
                          {/* Step number */}
                          <div className="mb-4 inline-flex h-8 w-8 items-center justify-center rounded-full bg-primary/20 text-sm font-bold text-primary-light">
                            {i + 1}
                          </div>

                          <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-primary/10 text-primary-light transition-all duration-300 group-hover:bg-primary/20 group-hover:scale-110">
